 ...
 */
session_start();
$base_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . rtrim(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_NAME'])))), '/\\') . '/';
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <div class="rc-pane-content">
            ...
            <div id="mail-compose-pane" style="display: none;">
                <div class="rc-compose-box">
                    ...
                    <form method="post" action="<?php echo $base_url; ?>index.php/webmail/send_message" target="_parent">
