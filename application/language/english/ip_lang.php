...
$lang = [
    ...
    'custom_templates_upgrade_required'             => 'Custom template configuration required',
    'custom_templates_upgrade_required_docs'        => 'For upgrade instructions, read <a href="https://github.com/invoiceplane/blob/develop/.github/docs/UPGRADE.md" target="_blank" rel="noopener">UPGRADE.md</a> and <a href="https://github.com/InvoicePlane/InvoicePlane/blob/develop/.github/docs/MIGRATION_GUIDE_v1.7.2.md" target="_blank" rel="noopener">MIGRATION_GUIDE_v1.7.2.md</a>.',
    'custom_templates_upgrade_required_ipconfig'    => 'Copy each template name without the .php extension into the matching ipconfig.php variable shown below. Also make sure CUSTOM_TEMPLATES_FOLDER points to the folder that contains your invoice_templates and quote_templates directories.',
    'custom_templates_upgrade_required_message'     => 'InvoicePlane no longer discovers custom templates from the filesystem. These saved template settings are not in the current custom template allowlist and may disappear from the template selectors after upgrading:',
    ...
    'no_logo_to_remove'                             => 'No logo configured to remove.',
    'failed_to_delete_logo'                         => 'Failed to delete logo file. Please check file permissions.',
    'invoice'                                       => 'Invoice',
    ...
    'invoice_logo_removed'                          => 'Invoice logo successfully removed',
    ...
    'login_logo_removed'                            => 'Login logo successfully removed',
    ...
    'pdf_invoice_footer_hint'                       => 'Footer supports basic HTML formatting (b, strong, i, em, u, p, br, span, small, div); external resources and other tags are stripped for security.',
    'pdf_quote_footer'                              => 'Quote footer',
    'pdf_quote_footer_hint'                         => 'Footer text is rendered as plain text; HTML is stripped and external resources are blocked for security.',
    ...
    'add_pic'                                       => 'Add PIC',
    'edit_pic'                                      => 'Edit PIC',
    'delete_pic_warning'                            => 'Are you sure you want to delete this PIC?',
    'pic_name'                                      => 'PIC Name',
    'pic_position'                                  => 'Position / Role',
    'pic_email'                                     => 'PIC Email',
    'pic_phone'                                     => 'PIC Phone / Mobile',
    'pic_notes'                                     => 'PIC Notes',
    'no_pics_found'                                 => 'No PICs found for this client.',
    'phone'                                         => 'Phone',
    'phone_abbr'                                    => 'P',
    ...
    'please_remove_and_reupload'                    => 'Please remove the logo and upload a PNG, JPG, or GIF file instead.',
    'port'                                          => 'Port',
    'position'                                      => 'Position',
    'prefix'                                        => 'Prefix',
    'prev'                                          => 'Prev',
    ...
    'setup_complete_secure_setup'                   => 'For security, please edit your <code>ipconfig.php</code> file and set both <code>DISABLE_SETUP=true</code> and <code>SETUP_COMPLETED=true</code>. You will receive a warning reminder when you log in as an administrator if this is not done.',
    ...
    'log_setup_failed_read_ipconfig'                => 'Failed to read ipconfig.php during post-setup tasks. Setup flags may not be set correctly. Error',
    'log_setup_preg_replace_failed_setup_completed' => 'preg_replace failed for SETUP_COMPLETED flag. Possible PCRE error.',
    'log_setup_flag_not_found_setup_completed'      => 'SETUP_COMPLETED flag not found in ipconfig.php. Setup may be misconfigured.',
    'log_setup_preg_replace_failed_disable_setup'   => 'preg_replace failed for DISABLE_SETUP flag. Possible PCRE error.',
    'log_setup_flag_not_found_disable_setup'        => 'DISABLE_SETUP flag not found in ipconfig.php. Setup may be misconfigured.',
    'log_setup_failed_write_ipconfig'               => 'Failed to write to ipconfig.php during post-setup tasks. Setup flags may not be set correctly. Error',
